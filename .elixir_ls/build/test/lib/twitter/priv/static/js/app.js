...
if (document.getElementById("signin")) {
  ...
  document.getElementById("signin").onclick = function () {
    channel.push('login', { userName: _userName.val(), password: password.val() });
  };
}

if (document.getElementById("btnFollow")) {
  var _userName2 = $('#userName');
  var followerUserName = $('#followerUser');
  var _userName2 = window.location.hash.substring(1);
  document.getElementById("btnFollow").onclick = function () {
    channel.push('followUser', { followerUserName: followerUser.val(), userName: _userName2 });
  };
}
...
channel.on('getFollowingUserTweet', function (payload) {
...
channel.on('getMentionedTweets', function (payload) {
...
channel.on('getSubscribedToTweets', function (payload) {
...
channel.on('queryHashtagsTweets', function (payload) {
